...
def dashboard():
    ...
    #     labels=labels,
    # )
    return render_template("dashboard.html", unit_list = unit_list, date_list = date_list[-30:], time_list = time_list[-30:], red_line_list = red_line_list, blue_line_list = blue_line_list, yellow_line_list = yellow_line_list, net_current_list = net_current_list)
